...
export default function FormGroupFecha(props:formGroupFechaProps){
    ...
    return(
        <div className="form-group">
            ...
            <input type="date" className="form-control" id={props.campo} name={props.campo} defaultValue={values[props.campo]?.toLocalDateString('en-CA')}
            onChange={e=>{
            ...
            />
            {touched[props.campo] && errors[props.campo] ? <MostrarErrorForm mensaje={errors[props.campo]?.toString()} /> : null}
        </div>
    )
}
